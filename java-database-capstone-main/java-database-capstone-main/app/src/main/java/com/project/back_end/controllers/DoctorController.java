...
public class DoctorController {
    ...
    public ResponseEntity<Map<String, Object>> getDoctorAvailability(
        ...
        ResponseEntity<Map<String, String>> validationResponse = healthcareService.validateToken(token, user);
    ...
    public ResponseEntity<Map<String, String>> saveDoctor(
        ...
        ResponseEntity<Map<String, String>> validationResponse = healthcareService.validateToken(token, "admin");
    ...
    public ResponseEntity<Map<String, Object>> filter(
        ...
        Map<String, Object> filteredDoctors = healthcareService.filterDoctor(name, time, speciality);
